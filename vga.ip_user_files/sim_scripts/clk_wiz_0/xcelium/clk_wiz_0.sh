...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../vga.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/prasic/Schreibtisch/PrASIC_Data/vga/vga.cache/compile_simlib/xcelium"
  fi
