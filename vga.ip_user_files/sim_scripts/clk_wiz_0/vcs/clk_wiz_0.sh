...
#
# Script generated by Vivado on Mon Feb 26 11:02:58 CET 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../vga.gen/sources_1/ip/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/prasic/Schreibtisch/PrASIC_Data/vga/vga.cache/compile_simlib/vcs"
  fi
